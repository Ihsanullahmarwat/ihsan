...
error_reporting("E-NOTICE");
 ...
 $insert_into2 = "update   menu set item_name='$item_name' ,price='$price' , description='$description' , presence='$presence' where item_id=".$identity;
 
 if(mysqli_query($conn2, $insert_into2)) {
    echo "<script> alert ('Data updated Successfully.'); window.location.assign('enable_disable_items.php'); </script>";
 } else {
   ...
   if(isset($_GET['upda']) && $_GET['upda']=='upda2' ) {
	  
 
  $select48 =  mysqli_query($conn2,"select * from menu where item_id=".$_GET['i_id']);
 
 
		$res4 = mysqli_fetch_assoc($select48);
...
<div class=" col-md-6 col-md-offset-3 ; flash4">
				...
				<br> 
				   ...
				   <input type="text" name="item_name"  placeholder="Item Name" value='<?php echo $res4['item_name'];?>' class="form-control" required >
				   </div> 

					 <div class="form-group col-md-10 col-md-offset-1">
				   <input type="text" name="price"  placeholder="Price" value='<?php echo $res4['price'];?>' class="form-control" required >
				   </div> 
				   
				   
				   	<div class="form-group col-md-10 col-md-offset-1">
				   <input type="text" name="description"  placeholder="Full Description" value='<?php echo $res4['description'];?>'  class="form-control" required >
				   </div> 				   
				   ...
				   <button type="submit" name="submit28" value="<?php echo  $_GET['i_id']?>" class="btn btn-success btn-block">Submit</button>
				   </div> 
				    </div>
